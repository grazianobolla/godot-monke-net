...
public partial class ClientNetworkClock : ClientNetworkNode
{
    ...
    private void SyncReceived(ClockSync sync)
    {
    ...
    private void OnTimerOut()
    {
        ...
        SendCommandToServer(MessageTypeEnum.ClockSync, sync, INetworkManager.PacketModeEnum.Unreliable, 1);
    }
